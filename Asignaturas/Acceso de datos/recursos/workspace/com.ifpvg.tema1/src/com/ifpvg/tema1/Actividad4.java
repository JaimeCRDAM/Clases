	...
	public static void main(String[] args) throws IOException{
		...
		if(posicion >= file.length()) {
			...
			//for(;;) { //recorro el fichero
				...
				//me coloco en la posicion de salario
				posicion=posicion+28;
				file.seek(posicion);
				salario= file.readDouble(); //obtengo el salario
				//vuelvo a la posicion de salario para aumentarlo
				file.seek(posicion);
				salarioNuevo = salario + cantidad;
				
				System.out.println("ID: " + id + ", Apellido: " + apellidos + ", Salario antiguo: " + salario + ", Salario nuevo: " + salarioNuevo);
