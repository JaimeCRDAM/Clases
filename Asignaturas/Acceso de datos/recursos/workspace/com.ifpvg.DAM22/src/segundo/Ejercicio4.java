...
public class Ejercicio4 extends JFrame {
	...
	public Ejercicio4() {
		...
		btnConsultar.setBounds(211, 64, 89, 23);
	...
	void consultar() {
		...
		Equipo equipo = (Equipo) session.createQuery("from Equipo as e " + "where e.codequipo = ? ").setString(0, txtCodigo.getText().toUpperCase())
				.uniqueResult();
		if (equipo != null) {
				//System.out.println("equipo encontrado");
			txtDenominacion.setText(equipo.getDenoequipo());
			txtEntrenador.setText(equipo.getEntrenador());
			txtProvincia.setText(equipo.getProvincia());
		} else {
			JFrame jFrame = new JFrame();
			JOptionPane.showMessageDialog(jFrame, "NO SE HA ENCONTRADO EL EQUIPO");
