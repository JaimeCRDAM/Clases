...
namespace Informes_Ertes_V2 {
    ...
    public partial class bd_ertesDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationempleados_fk_empr1;
        
        private global::System.Data.DataRelation relationertes_fk_empr1;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationempleados_fk_empr1 = this.Relations["empleados_fk_empr1"];
            this.relationertes_fk_empr1 = this.Relations["ertes_fk_empr1"];
        }
        ...
        private void InitClass() {
            ...
            this.relationempleados_fk_empr1 = new global::System.Data.DataRelation("empleados_fk_empr1", new global::System.Data.DataColumn[] {
                        this.tableDataTable1.CifColumn}, new global::System.Data.DataColumn[] {
                        this.tableEMPLEADOS.EmpresaColumn}, false);
            this.Relations.Add(this.relationempleados_fk_empr1);
            this.relationertes_fk_empr1 = new global::System.Data.DataRelation("ertes_fk_empr1", new global::System.Data.DataColumn[] {
                        this.tableDataTable1.CifColumn}, new global::System.Data.DataColumn[] {
                        this.tableERTES.EmpresaColumn}, false);
            this.Relations.Add(this.relationertes_fk_empr1);
        }
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DataTable1Row AddDataTable1Row(string Cif, string Nombre, string Descripcion) {
        ...
        public partial class EMPLEADOSRow : global::System.Data.DataRow {
            ...
            public DataTable1Row DataTable1Row {
                get {
                    return ((DataTable1Row)(this.GetParentRow(this.Table.ParentRelations["empleados_fk_empr1"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["empleados_fk_empr1"]);
                }
            }
        ...
        public partial class ERTESRow : global::System.Data.DataRow {
            ...
            public DataTable1Row DataTable1Row {
                get {
                    return ((DataTable1Row)(this.GetParentRow(this.Table.ParentRelations["ertes_fk_empr1"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["ertes_fk_empr1"]);
                }
            }
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public int Id_erte {
                get {
                    return ((int)(this[this.tableDataTable1.Id_erteColumn]));
                }
                set {
                    this[this.tableDataTable1.Id_erteColumn] = value;
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EMPLEADOSRow[] GetEMPLEADOSRows() {
                if ((this.Table.ChildRelations["empleados_fk_empr1"] == null)) {
                    return new EMPLEADOSRow[0];
                }
                else {
                    return ((EMPLEADOSRow[])(base.GetChildRows(this.Table.ChildRelations["empleados_fk_empr1"])));
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ERTESRow[] GetERTESRows() {
                if ((this.Table.ChildRelations["ertes_fk_empr1"] == null)) {
                    return new ERTESRow[0];
                }
                else {
                    return ((ERTESRow[])(base.GetChildRows(this.Table.ChildRelations["ertes_fk_empr1"])));
                }
            }
        }
...
namespace Informes_Ertes_V2.bd_ertesDataSetTableAdapters {
...
SELECT Dni, Nombre, Apellidos, Email, Domicilio, Foto, Empresa FROM EMPLEADOS WHERE (Dni = @Dni)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Informes_Ertes_V2.Properties.Settings.Default.bd_ertesConnectionString;
        }
...
SELECT Id_erte, Empresa, Fecha_inicio, Fecha_fin FROM ERTES WHERE (Id_erte = @Id_erte)";
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        ERTES.Id_erte, EMPRESAS.Cif, EMPRESAS.Nombre, SECTORES.Descripcion
FROM            EMPRESAS INNER JOIN
                         ERTES ON EMPRESAS.Cif = ERTES.Empresa INNER JOIN
                         SECTORES ON EMPRESAS.Sector = SECTORES.Id_sector";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        ERTES.Id_erte, EMPRESAS.Cif, EMPRESAS.Nombre, SECTORES.Descripcion
FROM            EMPRESAS INNER JOIN
                         ERTES ON EMPRESAS.Cif = ERTES.Empresa INNER JOIN
                         SECTORES ON EMPRESAS.Sector = SECTORES.Id_sector
WHERE        (SECTORES.Descripcion = @Param1)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param1", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Descripcion", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT        ERTES.Id_erte, EMPRESAS.Cif, EMPRESAS.Nombre, SECTORES.Descripcion
FROM            EMPRESAS INNER JOIN
                         ERTES ON EMPRESAS.Cif = ERTES.Empresa INNER JOIN
                         SECTORES ON EMPRESAS.Sector = SECTORES.Id_sector
WHERE        (EMPRESAS.Nombre LIKE @Param1)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(bd_ertesDataSet.DataTable1DataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual bd_ertesDataSet.DataTable1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bd_ertesDataSet.DataTable1DataTable dataTable = new bd_ertesDataSet.DataTable1DataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        public virtual int FillBy(bd_ertesDataSet.DataTable1DataTable dataTable, string Param1) {
        ...
        public virtual bd_ertesDataSet.DataTable1DataTable GetDataBySector(string Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Param1 == null)) {
                throw new global::System.ArgumentNullException("Param1");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByNombre(bd_ertesDataSet.DataTable1DataTable dataTable, string Param1) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual bd_ertesDataSet.DataTable1DataTable GetDataByNombre(string Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((Param1 == null)) {
                throw new global::System.ArgumentNullException("Param1");
            }
